...
const languages: Languages[] = [
  "mandarin", "chinese", "spanish", "arabic", "french", "persian", "german",
  "russian", "malay", "portuguese", "italian", "turkish", "lahnda", "tamil", 
  "urdu", "korean", "hindi", "bengali", "japanese", "vietnamese", "telugu", "marathi"
];
                ...
                <DialogContent>
                    ...
                    {summary && (
                        <div className="flex flex-col items-start max-h-96 overflow-y-scroll gap-2 p-5 bg-gray-100">
                            ...
                            <div className="blockgroup">{isPending ? "Thinking..." : <Markdown>{summary}</Markdown>}</div>
                        </div>
                    )}
                    <form className="flex gap-2" onSubmit={handleAskQuestion}>
                        ...
                        <Button type="submit" disabled={!language || isPending} variant="default">
